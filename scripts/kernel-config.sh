...
log "summary:"
grep -E "^(CONFIG_MODULES|CONFIG_EXT4_FS|CONFIG_VIRTIO|CONFIG_SERIAL_8250|CONFIG_BLK_DEV_INITRD|CONFIG_RANDOMIZE_MEMORY|CONFIG_BUG_ON_DATA_CORRUPTION|CONFIG_EARLY_PRINTK|CONFIG_SERIAL_EARLYCON|CONFIG_PRINTK_KTHREADS)=" \
