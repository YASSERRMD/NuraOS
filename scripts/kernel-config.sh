...
log "summary:"
grep -E "^(CONFIG_MODULES|CONFIG_EXT4_FS|CONFIG_VIRTIO|CONFIG_SERIAL_8250|CONFIG_BLK_DEV_INITRD|CONFIG_EARLY_PRINTK|CONFIG_SERIAL_8250_CONSOLE|CONFIG_PRINTK)=" \
